...
- 📜 **For evidence** → transparent, timestamped outputs suitable for academic and professional portfolios.  

---

## 🛠️ How to Use
1. Pick a topic folder.  
2. Read the **README** or **Manuscript** for details.
3. Follow the **lab-guide** **README** where referenced to reproduce the steps.   
